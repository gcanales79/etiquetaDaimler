...
function reporte() {
    console.log("https://shielded-stream-29921.herokuapp.com/fa9/produccionhora/" + horainicialx + "/" + horafinalx)
    axios.get("https://shielded-stream-29921.herokuapp.com/fa9/produccionhora/" + horainicialx + "/" + horafinalx)
        .then(datos => {
            const {data}=datos;
            console.log(data.data.count)
            axios.post("https://shielded-stream-29921.herokuapp.com/fa9/reporte", {
