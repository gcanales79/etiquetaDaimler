$(document).ready(function() {
    ...
    function produccionPorhora() {
      ...
      for (let i = 0; i < 9; i++) {
        ...
        //console.log(`/fa9/produccionhora/${fechainicial}/${fechafinal}`)
        $.get("/fa9/produccionhora/" + fechainicial + "/" + fechafinal, function(
          datos
        ) {
    ...
    function produccionTurnos() {
      ...
      for (let i = 0; i < 7; i++) {
        ...
        $.when(
          $.get(
            "/fa9/produccionhora/" + fechaInicalDiax + "/" + fechaFinaldiax,
            function(datos) {
              const { data } = datos;
          ...
          $.get(
            "/fa9/produccionhora/" + fechaInicaltardex + "/" + fechaFinaltardex,
            function(datos) {
              const { data } = datos;
          ...
          $.get(
            "/fa9/produccionhora/" + fechaInicalnochex + "/" + fechaFinalnochex,
            function(datos) {
              const { data } = datos;
