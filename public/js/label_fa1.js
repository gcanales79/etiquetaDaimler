$(document).ready(function() {
  ...
  function produccionPorhora() {
    ...
    for (let i = 0; i < 9; i++) {
      ...
      //console.log(`/fa1/produccionhora/${fechainicial}/${fechafinal}`)
      $.get("/fa1/produccionhora/" + fechainicial + "/" + fechafinal, function(
        datos
      ) {
  ...
  function produccionTurnos() {
    ...
    for (let i = 0; i < 7; i++) {
      ...
      $.when(
        $.get(
          "/fa1/produccionhora/" + fechaInicalDiax + "/" + fechaFinaldiax,
          function(datos) {
            const { data } = datos;
        ...
        $.get(
          "/fa1/produccionhora/" + fechaInicaltardex + "/" + fechaFinaltardex,
          function(datos) {
            const { data } = datos;
        ...
        $.get(
          "/fa1/produccionhora/" + fechaInicalnochex + "/" + fechaFinalnochex,
          function(datos) {
            const { data } = datos;
