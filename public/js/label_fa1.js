$(document).ready(function() {
  ...
  function produccionPorhora() {
    ...
    for (let i = 0; i < 9; i++) {
      ...
      $.get("/fa1/produccionhora/" + fechainicial + "/" + fechafinal, function(datos) {
  ...
  function produccionTurnos() {
    ...
    for (let i = 0; i < 7; i++) {
      ...
      $.when(
        $.get("/fa1/produccionhora/" + x1i + "/" + x1f, function(d) { d1.splice(i, 0, d.data.count); }),
        $.get("/fa1/produccionhora/" + x2i + "/" + x2f, function(d) { d2.splice(i, 0, d.data.count); }),
        $.get("/fa1/produccionhora/" + x3i + "/" + x3f, function(d) { d3.splice(i, 0, d.data.count); })
  ...
  function produccionPorsemana() {
    ...
    for (let i = 9; i >= 0; i--) {
      ...
      $.when(
        $.get("/fa1/produccionhora/" + fechainicial + "/" + fechafinal, function(info) {
