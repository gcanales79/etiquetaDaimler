$(document).ready(function() {
    ...
    function produccionPorhora() {
      ...
      for (let i = 0; i < 9; i++) {
        ...
        //console.log(`/fa11/produccionhora/${fechainicial}/${fechafinal}`)
        $.get("/fa11/produccionhora/" + fechainicial + "/" + fechafinal, function(
          datos
        ) {
    ...
    function produccionTurnos() {
      ...
      for (let i = 0; i < 7; i++) {
        ...
        $.when(
          $.get(
            "/fa11/produccionhora/" + fechaInicalDiax + "/" + fechaFinaldiax,
            function(datos) {
              const { data } = datos;
          ...
          $.get(
            "/fa11/produccionhora/" + fechaInicaltardex + "/" + fechaFinaltardex,
            function(datos) {
              const { data } = datos;
          ...
          $.get(
            "/fa11/produccionhora/" + fechaInicalnochex + "/" + fechaFinalnochex,
            function(datos) {
              const { data } = datos;
